...
Export key that exists on local:

```

gpg --export -a "Nate Smith"
...
Download key from keyserver with fingerprint:

```

gpg --keyserver keyserver.ubuntu.com --recv  C99B11DEB97541F0
